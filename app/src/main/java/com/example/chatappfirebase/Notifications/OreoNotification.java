package com.example.chatappfirebase.Notifications;
...
public class OreoNotification extends ContextWrapper {
    private static final String CHANNEL_ID = "com.example.chatappfirebase";
    private static final String CHANNEL_NAME = "chatappfirebase";
